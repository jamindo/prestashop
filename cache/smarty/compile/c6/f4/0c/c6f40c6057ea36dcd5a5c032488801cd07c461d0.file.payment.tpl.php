<?php /* Smarty version Smarty-3.1.14, created on 2014-01-26 14:05:02
		...
		<div id="contour" class="contour">
			<div id="carteForm" class="carteForm">
				<div id="carte"><h1>Effectuer le paiment</h1><div>Saisissez les informations de votre carte bancaire.</div><br>
					...
					<div id="CB_img"><img src="img/cb_visa_mastercard.png" height="40 px" width="205px" alt="CB / VISA / MASTERCARD"></div>
