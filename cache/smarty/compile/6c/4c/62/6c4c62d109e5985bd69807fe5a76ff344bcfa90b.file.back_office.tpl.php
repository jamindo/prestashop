<?php /* Smarty version Smarty-3.1.14, created on 2014-01-16 11:05:10
         compiled from "C:\xampp\htdocs\prestashop\modules\paypal\views\templates\admin\back_office.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2018752d7aed6e8f305-33666679%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6c4c62d109e5985bd69807fe5a76ff344bcfa90b' => 
    array (
      0 => 'C:\\xampp\\htdocs\\prestashop\\modules\\paypal\\views\\templates\\admin\\back_office.tpl',
      1 => 1389866702,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2018752d7aed6e8f305-33666679',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_52d7aed720fd62_86600377',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52d7aed720fd62_86600377')) {function content_52d7aed720fd62_86600377($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include 'C:\\xampp\\htdocs\\prestashop\\tools\\smarty\\plugins\\modifier.escape.php';
?>
...
" autocomplete="off" /></dd>
 ...
 : </label></dt>
						<dd><input type='password' name="api_password" id="api_password" value="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['PayPal_api_password']->value, 'html', 'UTF-8');?>
" autocomplete="off" /></dd>
						<dt><label for="api_signature"><?php echo $_smarty_tpl->tpl_vars['PayPal_content']->value['credentials_signature'];?>
 : </label></dt>
						<dd><input type='text' name="api_signature" id="api_signature" value="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['PayPal_api_signature']->value, 'html', 'UTF-8');?>
" autocomplete="off" /></dd>
					</dl>
					<div class="clear"></div>
